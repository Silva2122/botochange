...
start = {
    ...
    'text': 'Привет!',
    'markup': [
        ['👁 Смотреть пост', '➕ Подписаться на канал'],
        ['📈 Для рекламодателей'],
        ['👤 Мой профиль', '💵 Баланс'],
...
rules = {
    'text': '''👮ПРАВИЛА использования бота "Easy Money"

👨‍💻Исполнителям ЗАПРЕЩАЕТСЯ :

1. Отписываться от канала (в течении 7 дней);
...
👔Рекламадателям ЗАПРЕЩАЕТСЯ :

1. Размещать каналы мошенничества, порнографического содержания, а также группы с пропагандой наркотиков и терроризма, а также группы оказывающие негативное психологическое воздействие.
...
3.Производить вывод денег пополненых на рекламу.
4.Производить вывод бонусных денег.
5.Рекламные деньги нельзя потратить на рассылку.

💸Регламент на ввод и вывод средств от 1 минуты до  24 часов''',
    'markup': start['markup']
}
...
Выберите услугу в меню👇🏻""",
    'markup': [['👀 Просмотры', '👥 Подписки'], ['Мои заказы'], ['🔙 Начало']],
}
for_advert_admin = {
...
⛔️Минимальная стоимость: 0.05 рублей.''',
    'markup': [['⛔️ Отмена']]
}
